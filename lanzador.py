...
def index():
    ...
    datos_nivel_carga = obtener_dato_api('/termostato/nivel_de_carga/')
    ...
    formulario.nivel_carga_bateria = datos_nivel_carga.get('nivel_de_carga', 'N/A') if datos_nivel_carga else 'Error API'
